...
const {ProgramaIntervenciones, progIntervSchema} = require('./programa_intervenciones.model');
...
function configurarModelos(sequelize){
  ...
  ProgramaIntervenciones.init(progIntervSchema, ProgramaIntervenciones.config(sequelize));
}
